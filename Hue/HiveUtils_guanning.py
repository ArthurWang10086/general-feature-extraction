...
if __name__ == '__main__':
    ...
    for t in range(0,1):
        date_0 = datetime.date.today().strftime('%Y-%m-%d')
        date_7 = (datetime.date.today()-datetime.timedelta(7)).strftime('%Y-%m-%d')
        date_1 = (datetime.date.today()-datetime.timedelta(1)).strftime('%Y-%m-%d')
        sql = '''
    ...
    on a.id=c.role_id
                  '''%(date_0,date_7,date_1,date_7,date_1,date_7,date_1)
